...
def main():
    ...
    raw_data.pop(0)
    create_frequency_diagram(raw_data, 1, "League", "Number of Instances per League", "IPL.jpg")

    create_boxplot(raw_data,1,2,"Age","League","Age.jpg")
    create_boxplot(raw_data,1,3,"HoursPerWeek","League","HoursPerWeek.jpg")
    create_boxplot(raw_data,1,4,"TotalHours","League","TotalHours.jpg")
    create_boxplot(raw_data,1,5,"APM","League","APM.jpg")
    create_boxplot(raw_data,1,6,"SelectByHotkeys","League","SelectByHotkeys.jpg")
    create_boxplot(raw_data,1,7,"AssignToHotkeys","League","AssignToHotkeys.jpg")
    create_boxplot(raw_data,1,8,"UniqueHotkeys","League","UniqueHotkeys.jpg")
    create_boxplot(raw_data,1,9,"MinimapAttacks","League","MinimapAttacks.jpg")
    create_boxplot(raw_data,1,10,"MinimapRightClicks","League","MinimapRightClicks.jpg")
    create_boxplot(raw_data,1,11,"NumberOfPACs","League","NumberOfPACs.jpg")
    create_boxplot(raw_data,1,12,"GapBetweenPACs","League","GapBetweenPACs.jpg")
    create_boxplot(raw_data,1,13,"ActionLatency","League","ActionLatency.jpg")
    create_boxplot(raw_data,1,14,"ActionsInPAC","League","ActionsInPAC.jpg")
    create_boxplot(raw_data,1,15,"TotalMapExplored","League","TotalMapExplored.jpg")
    create_boxplot(raw_data,1,16,"WorkersMade","League","WorkersMade.jpg")
    create_boxplot(raw_data,1,17,"UniqueUnitsMade","League","UniqueUnitsMade.jpg")
    create_boxplot(raw_data,1,18,"ComplexUnitsMade","League","ComplexUnitsMade.jpg")
    create_boxplot(raw_data,1,19,"ComplexAbilityUsed","League","ComplexAbilityUsed.jpg")
    create_boxplot(raw_data,1,20,"MaxTimeStamp","League","MaxTimeStamp.jpg")
